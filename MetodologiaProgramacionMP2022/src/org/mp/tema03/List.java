...
public interface List<E> extends Iterable<E>{
  ...
  /** Devuelve el elemento de la lista que esté en la posición especificada por index */
  ...
  /** Sustituye el elemento de la posición especificada por index en la lista
