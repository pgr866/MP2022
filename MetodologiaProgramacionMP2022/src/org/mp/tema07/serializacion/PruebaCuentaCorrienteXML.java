...
public class PruebaCuentaCorrienteXML {
	...
	public static void main(String[] args) throws Exception {
		...
		String archivoDatos = directorioEntrada + File.separator + "src" + File.separator + "org" + File.separator
				+ "mp" + File.separator + "tema07" + File.separator + "serializacion" + File.separator + "cuenta.xml";

		CuentaCorrienteXML cuentaXml = new CuentaCorrienteXML(archivoDatos);
...
//		cuenta.addMovimiento(m1);
		...
		cuentaXml.escribir(cuenta);
		cuenta = cuentaXml.leer();
		cuenta.listado();
	}
}
